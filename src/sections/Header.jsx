...
const Header = () => {
  ...
  return (
    <header className='fixed left-0 top-0 w-full z-50 py-10 border border-amber-300'>
          ...
          <div className='max-lg:relative max-lg:min-h-screen max-lg:flex max-lg:flex-col max-lg:p-6 max-lg:overflow-hidden sidebar-before max-md:px-4'>
            ...
            <div className="lg:hidden block absolute top-1/2 left-0 w-[960px] h-[380px] translate-x-[-290px] -translate-y-1/2 rotate-90">
              <img
                ...
                height={380}
                alt="outline"
                // className={clsx("relative z-2 transition-all duration-500 delay-300", isOpen ? "translate-y-0" : "translate-y-[500px]")}
